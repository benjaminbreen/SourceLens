...
export default async function handler(
  ...
  try {
    ...
    const prompt = lensType 
      ? buildLensPrompt(source, metadata, perspective, lensType) 
...
2. Create a short first-person narrative (100 words) in markdown italics from their perspective that:
...
2. Create a BREIF narrative (no more than 100 words, and as few as 20) in markdown italics from this place's perspective that:
...
Remember that this is not merely a creative exercise but a scholarly tool. While imaginative, your response must be historically accurate regarding the place's features and history. It should reveal how spatial dimensions affect power relations, inclusion/exclusion, and historical memory.

Format your response with a #title that names the place, followed by its "testimony." Begin with "# [The Witness of...]" and then the narrative in italics. Use paragraph breaks.  Conclude with a brief "# Explanation" of how this spatial perspective changes our understanding of the source.`;
...
Your task is to create a short narrative reconstructing the provenance of this source - how it came to be created, preserved, and studied - while imagining what other potential sources were excluded from this process of historical preservation and remembering. Use frequent paragraph breaks.

1. Create a three-part narrative (100 words total) that explores:
...
For each stage, identify what was potentially lost or excluded from the historical record, and how that absence shapes our understanding of the past.
